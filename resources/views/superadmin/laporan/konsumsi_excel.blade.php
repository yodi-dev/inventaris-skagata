...
<body>
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <th class="th-col" width="9%">Waktu Transaksi</th>
            <th class="th-col" width="8%">Kode Barang</th>
            <th class="th-col" width="15%">Nama Barang BHP</th>
            <th class="th-col" width="9%">Sumber Dana</th>
            <th class="th-col" width="9%">Unit Bengkel</th>
            <th class="th-col" width="8%">Lokasi Simpan</th>
            <th class="th-col" width="8%">Harga Satuan</th>
            <th class="th-col" width="6%">Jumlah Dipakai</th>
            <th class="th-col" width="5%">Satuan</th>
            <th class="th-col" width="7%">Stok Sekarang (Saldo)</th>
            <th class="th-col" width="8%">Petugas / Staf</th>
            <th class="th-col" width="15%">Keterangan / Keperluan</th>
        </tr>
