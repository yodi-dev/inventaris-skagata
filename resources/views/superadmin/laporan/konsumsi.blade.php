    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Audit dan pantau distribusi serta pemakaian Bahan Habis Pakai (BHP) di
                    seluruh bengkel praktik.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-2xl flex items-center shadow-xs min-w-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Kuantitas Terpakai
                        </div>
                        <div class="text-xl font-bold text-amber-700">{{ number_format($totalQuantity, 0, ',', '.') }} <span
                                class="text-xs font-normal text-gray-500">Unit</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-2xl flex items-center shadow-xs min-w-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="text-xl font-bold text-gray-900">{{ number_format($totalBarangVarian, 0, ',', '.') }}
                            <span class="text-xs font-normal text-gray-500">Item</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-2xl flex items-center shadow-xs min-w-0">
                <div class="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Bengkel Terbanyak
                        </div>
                        <div class="text-sm font-bold text-gray-900 truncate" title="{{ $namaBengkelTerbanyak }}">
                            {{ $namaBengkelTerbanyak }}</div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tr class="hover:bg-slate-50 transition-colors group">
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <div class="flex items-center gap-1.5 mt-1">
                                        ...
                                        <span
                                            class="text-xs text-amber-700 bg-amber-50 border border-amber-200 px-1.5 py-0.5 rounded font-medium text-[11px]">
                                            BHP
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 text-center">
                                    <span
                                        class="inline-flex items-center gap-1 font-bold text-amber-700 bg-amber-50 border border-amber-200 px-2.5 py-1 rounded-full text-xs">
                                ...
                                <td class="py-4 px-4 whitespace-nowrap">
                                    @if ($item->user)
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900 text-xs">{{ $item->user->name }}
                                                </div>
                                                <div class="text-[11px] text-gray-400 capitalize">{{ $item->user->role }}
                                                </div>
                                            </div>
                                        </div>
                                    @else
                            ...
                            <tr>
                                <td colspan="7" class="py-12 px-4 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-base font-semibold text-gray-800">Tidak ada riwayat konsumsi bahan
                                            ditemukan</p>
                                        <p class="text-xs text-gray-400 mt-1 max-w-sm">
                                            Coba atur ulang tanggal filter atau sesuaikan kata kunci pencarian barang dan
                                            bengkel.
                                        </p>
                                    </div>
                                </td>
