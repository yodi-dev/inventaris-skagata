        ...
        <div class="sheet-canvas">
            <table>
                ...
                <tr>
                    ...
                    <th class="th-col" style="width: 8%;">Waktu Transaksi</th>
                    <th class="th-col" style="width: 8%;">Kode Barang</th>
                    <th class="th-col" style="width: 14%;">Nama Barang / Aset</th>
                    <th class="th-col" style="width: 8%;">Sumber Dana</th>
                    <th class="th-col" style="width: 8%;">Unit Bengkel</th>
                    <th class="th-col" style="width: 8%;">Lokasi Simpan</th>
                    <th class="th-col" style="width: 9%;">Jenis Mutasi</th>
                    <th class="th-col" style="width: 7%;">Harga Satuan</th>
                    <th class="th-col" style="width: 6%;">Perubahan</th>
                    <th class="th-col" style="width: 4%;">Satuan</th>
                    <th class="th-col" style="width: 7%;">Stok Sekarang (Saldo)</th>
                    <th class="th-col" style="width: 7%;">Petugas / Staf</th>
                    <th class="th-col" style="width: 13%;">Keterangan / Ref</th>
                </tr>
                @php
                    $jenisMap = [
