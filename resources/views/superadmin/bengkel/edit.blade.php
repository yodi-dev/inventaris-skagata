    ...
    <div class="max-w-5xl mx-auto space-y-6 pb-12">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Perbarui informasi identitas bengkel, program keahlian, dan staf penanggung jawab.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="p-4 bg-blue-50/60 border border-blue-100 rounded-xl flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="text-xs font-medium text-blue-600 uppercase tracking-wider">Aset Alat Terdaftar</div>
                        <div class="text-lg font-bold text-gray-900">450 Item</div>
                    </div>
                </div>
                <span class="text-xs text-blue-700 bg-blue-100 px-2.5 py-1 rounded-md font-semibold">Terkait</span>
            </div>

            <div class="p-4 bg-amber-50/60 border border-amber-100 rounded-xl flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg bg-amber-500 text-white flex items-center justify-center font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div>
                        <div class="text-xs font-medium text-amber-700 uppercase tracking-wider">Bahan Habis Pakai (BHP)</div>
                        <div class="text-lg font-bold text-gray-900">1.205 Item</div>
                    </div>
                </div>
                <span class="text-xs text-amber-800 bg-amber-100 px-2.5 py-1 rounded-md font-semibold">Terkait</span>
            </div>
        </div>

        <!-- Form Card -->
        <form id="formEditBengkel" action="{{ route('superadmin.master.bengkel') }}" method="GET" class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-6 sm:p-8 border-b border-gray-200 space-y-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Informasi nama, kode inventaris bengkel, dan bidang program keahlian.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg shadow-sm">
                            ...
                            <input type="text" id="kode_bengkel" name="kode_bengkel" required
                                value="TKJ"
                                placeholder="TKJ"
                                class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-lg border-gray-300 focus:border-primary-600 focus:ring-primary-600 text-sm font-mono uppercase font-semibold">
                        </div>
                        <p class="text-xs text-gray-400 mt-1">Prefix otomatis <code class="text-gray-600 font-semibold">BGK-</code> (Format: BGK-TKJ).</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="singkatan" name="singkatan" required
                            ...
                            class="w-full rounded-lg border-gray-300 focus:border-primary-600 focus:ring-primary-600 text-sm shadow-sm uppercase font-semibold">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="program_keahlian" name="program_keahlian" required
                            ...
                            <option value="Teknologi Informasi & Komunikasi" selected>Teknologi Informasi & Komunikasi (TIK)</option>
            ...
            <div class="p-6 sm:p-8 border-b border-gray-200 space-y-6 bg-slate-50/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Perbarui Kepala Bengkel dan staf Toolman yang bertugas di bengkel ini.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    ...
                    <div>
                        ...
                        <select id="toolman_id" name="toolman_id"
                            ...
                            <option value="1" selected>Joko Susilo (Toolman TKJ - Aktif)</option>
                        ...
                        <p class="text-xs text-gray-400 mt-1">Dihubungkan dengan hak akses akun Toolman di bengkel ini.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 sm:px-8 py-4 bg-gray-50 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3 w-full sm:w-auto justify-end order-1 sm:order-2">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-semibold shadow transition-all hover:shadow-md">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const form = document.getElementById('formEditBengkel');
                form.addEventListener('submit', function(e) {
                    e.preventDefault();
                    
                    const nama = document.getElementById('nama_bengkel').value || 'Bengkel';
                    const kode = document.getElementById('kode_bengkel').value || 'TKJ';

                    alert(`✅ Sukses (Prototipe UI):\nPerubahan data bengkel "${nama}" (BGK-${kode.toUpperCase()}) berhasil diperbarui!\n\nMengalihkan kembali ke daftar master bengkel...`);
