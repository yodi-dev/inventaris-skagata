                        ...
                        @method('PUT') <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select id="condition" name="condition"
                                    ...
                                    required>
                                    <option value="good"
                                        {{ old('condition', $item->condition) == 'good' ? 'selected' : '' }}>Baik
                                    </option>
                                    <option value="slightly_damaged"
                                        {{ old('condition', $item->condition) == 'slightly_damaged' ? 'selected' : '' }}>
                                        Rusak Ringan</option>
                                    <option value="heavily_damaged"
                                        {{ old('condition', $item->condition) == 'heavily_damaged' ? 'selected' : '' }}>
                                        Rusak Berat</option>
                                </select>
                                @error('condition')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
