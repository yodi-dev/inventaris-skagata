    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="logo.png" alt="Logo Sekolah" width="50" class="logo">
                    </a>
                </div>
            ...
            <div class="flex items-center">
                ...
                if (darkMode) { document.documentElement.classList.add('dark'); }" @click="darkMode = !darkMode"
                    class="p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 rounded-lg transition sm:me-4 me-2"
