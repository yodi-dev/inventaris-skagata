...
<body class="bg-slate-50 text-gray-800 font-sans antialiased min-h-screen flex flex-col justify-between selection:bg-primary-500 selection:text-white"
      x-data="{ 
          cartCount: 0,
          init() {
              const updateCount = () => {
    ...
    <header class="bg-white/95 backdrop-blur-md border-b border-gray-200 sticky top-0 z-30 shadow-xs">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3">
            ...
            <a href="{{ route('peminjam.katalog.index') }}" class="flex items-center space-x-2.5 group">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-tr from-primary-700 to-primary-500 text-white flex items-center justify-center font-black shadow-xs group-hover:scale-105 transition-transform">
                ...
                <div>
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-primary-50 text-primary-700 border border-primary-200">SKAGATA</span>
                    </div>
                    <p class="text-[10px] text-gray-400 font-medium leading-none hidden sm:block">Sistem Inventaris Bengkel</p>
                </div>
            </a>
            ...
            <div class="flex items-center space-x-2 sm:space-x-3">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-primary-100 text-primary-700 font-bold flex items-center justify-center text-xs border border-primary-200 shadow-2xs">
                        B
                    </div>
                </div>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-200 px-2 py-1.5 shadow-lg flex items-center justify-around">
        <!-- Katalog -->
        <a href="{{ route('peminjam.katalog.index') }}"
        ...
        <a href="{{ route('profile.edit') }}"
           class="flex-1 flex flex-col items-center justify-center py-1 rounded-lg text-gray-500 hover:text-gray-800 transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
