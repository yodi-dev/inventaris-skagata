...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* TABEL BARANG & KONDISI PENGEMBALIAN */
        .items-table {
            width: 100%;
            border-collapse: collapse;
    ...
    <div class="preview-wrapper">
        ...
        <div class="no-print-toolbar">
            <div class="toolbar-title">
                ...
                <span>Pratinjau Bukti Pengembalian Alat & Bahan Resmi</span>
        ...
        <div class="sheet-container">
            ...
            <table class="identitas-table">
                ...
                <tr>
                    <td class="identitas-label">Tgl. Selesai Dikembalikan</td>
                    <td class="identitas-separator">:</td>
                    <td class="identitas-value">
            ...
            <!-- DAFTAR BARANG DENGAN REKAPITULASI FISIK (BAIK, RUSAK, HILANG) -->
            <table class="items-table">
                <thead>
                    <tr>
                        <th rowspan="2" style="width: 30px;">No.</th>
                        <th rowspan="2" style="width: 95px;">Kode</th>
                        <th rowspan="2">Nama Alat / Bahan</th>
                        <th rowspan="2" style="width: 55px;">Qty Pinjam</th>
                        <th colspan="3" style="text-align: center;">Kondisi Saat Dikembalikan</th>
                        <th rowspan="2" style="width: 100px;">Status / Ket</th>
                    </tr>
                    <tr>
                        <th style="width: 50px; background-color: #ecfdf5; color: #047857;">Baik</th>
                        <th style="width: 50px; background-color: #fff7ed; color: #c2410c;">Rusak</th>
                        <th style="width: 50px; background-color: #fef2f2; color: #b91c1c;">Hilang</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($peminjaman->detailPeminjamans as $index => $detail)
                        @php
                            $baik = $detail->jumlah_baik ?? ($peminjaman->status === 'selesai' ? $detail->jumlah : '-');
                            $rusak = $detail->jumlah_rusak ?? 0;
                            $hilang = $detail->jumlah_hilang ?? 0;
                            $isComplete = $peminjaman->status === 'selesai';
                        @endphp
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="font-size: 8.5pt; color: #555555; font-family: Arial, sans-serif;">
                                    Lokasi: {{ $detail->barang->lokasiPenyimpanan->nama ?? 'Gudang Utama' }}
                                </div>
                            </td>
                            ...
                            <td class="text-center font-bold" style="color: #c2410c;">
                                {{ $isComplete ? ($rusak > 0 ? $rusak : '0') : '-' }}
                            </td>
                            <td class="text-center font-bold" style="color: #b91c1c;">
                                {{ $isComplete ? ($hilang > 0 ? $hilang : '0') : '-' }}
                            </td>
                            <td class="text-center" style="font-size: 9pt;">
                                @if ($isComplete)
                                    @if ($rusak == 0 && $hilang == 0)
                                        <span class="badge-cond" style="color: #047857;">Lengkap &amp; Baik</span>
                                    @elseif ($hilang > 0)
                                        <span class="badge-cond" style="color: #b91c1c;">Ada Hilang</span>
                                    @elseif ($rusak > 0)
                                        <span class="badge-cond" style="color: #c2410c;">Ada Kerusakan</span>
                                    @endif
                                @else
                                    <span style="color: #64748b;">Menunggu Cek</span>
                                @endif
                            </td>
                        </tr>
                    @empty
